...
const Product = ({ products }) => {
  ...
  const [selectedmoMarking, setSelectedmoMarking] = useState(
    mockdata[0].moMarking
  );

  const [selectedrunflat, setSelectedrunflat] = useState(mockdata[0].runflat);
  const [selectedimgUrl, setSelectedimgUrl] = useState(mockdata[0].imgUrl);
  const [selectedLogo, setSelectedLogo] = useState(mockdata[0].logo);
